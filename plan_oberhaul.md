...
- [ ] Debug `climate_futures_class.ipynb` and depreciate `climate_futures.ipynb` once it's working
...
- [ ] Integrate properly with `josh-py` processing, e.g. by downloading data directly into the bucket.
